  ...
  return (
    <div className="flex gap-4">
      <div className="flex flex-col items-center gap-1.5 pt-0.5">
        <div className="w-9 h-9 rounded-full flex items-center justify-center shrink-0 text-xs font-bold text-white" style={{ background: "#0C1419", border: "1px solid #1A2E3A" }}>
          {num}
        </div>
...
export default function InstructionsPanel({ step = 1 }: { step?: 1 | 2 | 3 }) {
  return (
    <div className="flex flex-col gap-8">
      <div className="inline-flex items-center gap-2 self-start px-3 py-1.5 rounded-full" style={{ background: "#0C1419", border: "1px solid #1A2E3A" }}>
      ...
      <div className="flex items-start gap-3 p-4 rounded-[10px]" style={{ background: "#0C1419", border: "1px solid #1A2E3A" }}>
