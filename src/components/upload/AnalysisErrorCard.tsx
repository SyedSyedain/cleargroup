...
export default function AnalysisErrorCard({ type, message, onRetry, onDismiss }: Props) {
  ...
  return (
    <motion.div
      ...
      style={{ background: "#1A0A0A", border: "1px solid #3A1A1A", borderRadius: 12, padding: 20 }}
    >
      <div className="flex items-start gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {type === "rate_limit" && countdown > 0 && (
            <div className="rounded-full overflow-hidden mb-3" style={{ height: 3, background: "#2A1A0A" }}>
              <motion.div
