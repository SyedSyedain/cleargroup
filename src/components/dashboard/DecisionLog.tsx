...
export default function DecisionLog({ decisions }: { decisions: Decision[] }) {
  return (
    <div>
      ...
      {decisions.length === 0 ? (
        <div className="flex flex-col items-center justify-center gap-2 py-10" style={{ background: "#0C1419", border: "1px solid #1A2E3A", borderRadius: 12 }}><Gavel size={24} style={{ color: "#3A5060" }} /><p className="text-sm" style={{ color: "#3A5060" }}>No decisions recorded in this chat</p></div>
      ) : (
