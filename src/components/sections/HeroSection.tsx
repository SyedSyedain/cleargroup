...
// Full-viewport hero â€” blobs, radial glow, and all hero sub-sections
export default function HeroSection() {
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-cg-bg px-6 pt-8 pb-24">
      ...
      {/* Background blob â€” indigo, top-left area */}
      ...
      {/* Background blob â€” purple, bottom-right area */}
      ...
      {/* Mesh blob 1 â€” sea green, top-right */}
      ...
      {/* Mesh blob 2 â€” emerald, center-left */}
      ...
      {/* Mesh blob 3 â€” sea green, bottom-center */}
      ...
      <div className="relative z-10 w-full max-w-[900px] mx-auto flex flex-col items-center text-center gap-6">
        ...
        >
          Upload your group chat. Get instant tasks, decisions, and accountability&nbsp;â€” in 30 seconds.
        </motion.p>
